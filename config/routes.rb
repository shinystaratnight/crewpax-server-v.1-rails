Bcpax::Application.routes.draw do
  ...
  resources :unions, only:[:create,:update, :index, :destroy]
  resources :roles, only:[:create,:update, :index, :destroy]
  resources :certificates, only:[:create,:update, :index, :destroy]
