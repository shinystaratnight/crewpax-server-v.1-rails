...
asst._costume_designer_coordinator = iatse.roles.create(name: "Asst. Costume Designer/Coordinator")
set_supervisor = iatse.roles.create(name: "Set Supervisor")
performer_s_costumer = iatse.roles.create(name: "Performer's Costumer")
...
2nd_assistant_office_coordinator = iatse.roles.create(name: "2nd Assistant Office Coordinator")
...
set_decorator = iatse.roles.create(name: "Set Decorator")
...
vfx = none.roles.create(name: "VFX")
...
props.eligibilities.create(union_id: 6)
set_decorator.eligibilities.create(union_id: 6)
